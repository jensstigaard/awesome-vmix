...
#### Paid / Licensed
  ...
  * ![Price paid](https://img.shields.io/badge/price-free%20trial%20%2B%20license-orange) [Directors Plan - by Adelvo](https://adelvo.io/directors-plan/) - Visual timeline automation, controller and one-click Companion export for vMix. macOS + Windows.
  * ![Price paid](https://img.shields.io/badge/price-free%20trial%20%2B%20license-orange) [LLT - Local Live Translator - by Adelvo](https://adelvo.io/llt/) - Real-time speech translation with direct vMix Title output. Runs 100% local on Apple Silicon (Whisper + Mistral MLX) or connects to Google / Deepgram / AssemblyAI / Azure. 101 languages, macOS.
